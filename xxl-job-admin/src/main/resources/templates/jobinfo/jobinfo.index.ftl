                        ...
                        <div class="box-body">
                            <table id="job_list" class="table table-bordered table-striped" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th name="jobTime">任务时间</th>
                                    <th name="timespan">任务周期</th>
                                    <th name="depend">任务依赖</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">CHECK</p>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">开启</label>
                        <div class="col-sm-4"><input type="checkbox" name="jobCheck" value="1"></div>
                        <label for="lastname" class="col-sm-2 control-label">任务时间</label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="jobTime"
                                                     placeholder="yyyy-MM-dd HH:mm:ss" maxlength="50"></div>

                    </div>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">任务周期</label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="timespan" placeholder="秒"
                                                     maxlength="50"></div>
                        <label for="lastname" class="col-sm-2 control-label">任务依赖</label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="depend" placeholder="’,‘分隔"
                                                     maxlength="50"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">CHECK</p> <#-- 调度配置 -->
